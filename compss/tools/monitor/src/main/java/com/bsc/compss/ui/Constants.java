...
public class Constants {
	...
	public static final String NO_CONNECTION_IMG_PATH = File.separator + "compss-monitor" + File.separator + "svg" + File.separator + "loadGraphNoConnection.png";
	...
	public static final int CORE_COLOR_MAX = 12;				//Included
