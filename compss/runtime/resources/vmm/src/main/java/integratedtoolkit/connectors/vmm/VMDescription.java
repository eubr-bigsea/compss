...
public class VMDescription extends VMRequest {
	...
	/*{
	    ...
	    "hostName": "computeHost1",
	    "dateCreated": "Tue May 20 13:30:33 CEST 2014",
	 ...
	 * @param applicationId
	 */
	public VMDescription(String id, String name, String image, int cpus, int ramMb,
			int diskGb, String state, String ipAddress, String hostName, String dateCreated, String applicationId) {
